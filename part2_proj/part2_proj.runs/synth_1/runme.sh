...
HD_PWD='/home/Vedi/school/ECE 524L/Lab2/fa22-e524-lab2-vedi97/hardware/part2/part2_proj/part2_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_convert.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_convert.tcl
